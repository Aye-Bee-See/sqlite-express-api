...
└── database/
    ...
    ├── retention.js                  runRetention() and windowFor(): purge mailed letters and replies past the writer's window; `npm run retention`.
