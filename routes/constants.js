...
const messages = {
	...
	user: {
		get: {
			...
			protect: {
				success: {
					condition: {
						par: 'Congrats! You are seeing this because you are authorized.'
					}
				},
		...
		post: {
			...
			login: {
				...
				error: {
					condition: { par: 'No such user or associated password found.' }
				}
			}
		},
		put: {
	...
	prisoner: {
		get: {
			many: {
				success: {
					condition: { par: 'Successfully retireved prisoners list' }
				},
				error: {
					condition: {
